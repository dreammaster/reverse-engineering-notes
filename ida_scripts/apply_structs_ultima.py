...
Companion to apply_renames_ultima.py, same rationale: one accumulating,
...
Convention: DRY_RUN starts True, same as apply_renames_ultima.py, until a first
...
from apply_renames_ultima.py's idc.set_name (which addresses one specific
