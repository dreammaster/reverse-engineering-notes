...
/* forward declaration for _dummy_init() below, ahead of the real
 * definition further down. Originally "extern" here despite the real
 * definition being "static" (digi_none is used only within this file) --
 * older GCC tolerated the mismatched linkage silently; current GCC
 * correctly rejects it as a conflicting declaration. */
