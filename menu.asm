...
sub_1210E       proc far                ; CODE XREF: sub_1210E:loc_1213B↓j
                mov     ax, 1
                push    ax
                mov     ax, ds:1B0Ah
                cwd
...
loc_1214E:                              ; CODE XREF: sub_1210E+6E↓j
                mov     ax, 1
                push    ax
                lea     bx, [bp-1Ch]
                push    ds
...
loc_12176:                              ; CODE XREF: sub_1210E+3D↑j
                mov     [bp-1Eh], ax
                cmp     ax, [bp-18h]
                jle     short loc_1214E
                mov     ax, 1B0Ch
...
loc_1280A:                              ; CODE XREF: sub_12778+D1↓j
                mov     ax, 1
                push    ax
                mov     ax, ds:1B0Ah
                cwd
...
loc_12843:                              ; CODE XREF: sub_12778+8E↑j
                mov     [bp-14h], ax
                cmp     ax, 8
                jle     short loc_1280A
                mov     ax, 1
...
loc_1286E:                              ; CODE XREF: sub_12778+11B↓j
                shl     ax, 1
                shl     ax, 1
                add     ax, 20E4h
                push    ax
...
loc_12885:                              ; CODE XREF: sub_12778+108↑j
                dec     word ptr ds:2138h

loc_12889:                              ; CODE XREF: sub_12778+10A↑j
                mov     ax, [bp-14h]
                inc     ax

loc_1288D:                              ; CODE XREF: sub_12778+F3↑j
                mov     [bp-14h], ax
                cmp     ax, 8
                jle     short loc_1286E
                lea     ax, [bp-12h]
...
loc_128F2:                              ; CODE XREF: sub_128A9+85↓j
                shl     ax, 1
                shl     ax, 1
                add     ax, 20E4h
                push    ax
...
loc_12928:                              ; CODE XREF: sub_128A9+45↑j
                mov     [bp-14h], ax
                cmp     ax, 8
                jle     short loc_128F2
                mov     ax, 1
...
word_1403F      dw 0                    ; DATA XREF: sub_13A6A+42↑w
                db 203Fh dup(0), 0Bh, 0, 54h, 21h, 6Dh, 6Eh, 6Dh, 62h
                db 74h, 31h, 38h, 30h, 3 dup(3Ch), 0C1h, 46h, 0
